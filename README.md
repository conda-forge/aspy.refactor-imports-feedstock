About aspy.refactor-imports-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aspy.refactor-imports-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9681&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aspy.refactor-imports-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aspy.refactor-imports` can be installed with `conda`:
...
```
mamba install aspy.refactor-imports
```

It is possible to list all of the versions of `aspy.refactor-imports` available on your platform with `conda`:
...
```
mamba search aspy.refactor-imports --channel conda-forge
```
...
mamba repoquery search aspy.refactor-imports --channel conda-forge

# List packages depending on `aspy.refactor-imports`:
mamba repoquery whoneeds aspy.refactor-imports --channel conda-forge

# List dependencies of `aspy.refactor-imports`:
mamba repoquery depends aspy.refactor-imports --channel conda-forge
```
